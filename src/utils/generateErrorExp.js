        ...
        try {
          if (
            ...
            essentialData.allErrors.allClaimsDetails.push({
              message: `依專利法施行細則${
                essentialData.applicationNum[3] === "1" ? "" : "第45條準用"
              }第22條第1項之規定：「說明書、申請專利範圍及摘要中之技術用語及符號應一致。」本案「申請專利範圍」第${num}項內容之記載未依前開規定之格式撰寫（該項所述標的名稱「${
                elNames[0]
              }」，與直接或間接依附之申請專利範圍第${refClaimNum}項標的名稱「${
                elNames[1]
      ...
      essentialData.allErrors_v2.law_112_5.push({
        ...
        message:
          ...
          claimErrors["對應關係未敘明"][num]
            ...
            .join("、") +
          `等構件，惟該些構件於空間上的安排、配置、連結或其對應關係未敘明，係${essentialData.applicationNum[3] === "1" ? "發明" : "新型"}結構特徵揭露明顯不清楚【說明書及圖式應記載獨立項所述構件及其連結關係，請一併檢視確認或修正】。`,
      })
    );
  }
